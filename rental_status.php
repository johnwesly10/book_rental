...
$fine_per_day = 10; // ₹10 fine per day after due date
$conn->query("UPDATE rentals SET rental_status = 'overdue' 
              WHERE rental_status = 'on rented' AND return_date < CURDATE()");

// Fetch rentals with fine calculation
$sql = "SELECT rentals.*, books.title, books.rent_amount, 
               users.username, users.email, users.phone_number, rentals.address, rentals.approval_status, rentals.rental_status,
...
<head>
  ...
  <link rel="stylesheet" href="css/rental_status.css">
</head>
<body>
